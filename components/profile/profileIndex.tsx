...
const ProfileIndex = () => {
  ...
  return (
    <div>
      ...
      <div className="justify-between flex-wrap hidden sm:block bg-black text-white rounded shadow">
        <div className="xl:w-full xl:mx-0 pl-5 pr-5 h-12">
          <ul className="flex">
            <li
              ...
              className={
                activeStatus == 1
                  ...
                  : "text-sm text-white py-3 mr-10 font-normal cursor-pointer hover:text-gray-800"
              }
            >
              <span className="mb-3 cursor-pointer">Intr</span>

              {activeStatus == 1 && (
                <div className="w-full h-4/6 bg-indigo-700 rounded-t-md" />
              )}
            </li>
            <li
            ...
            >
              <span className="mb-3 cursor-pointer">Clients</span>
              {activeStatus == 2 && (
            ...
            >
              <span className="mb-3 cursor-pointer">Work</span>
              {activeStatus == 3 && (
                <div className="w-full h-1 bg-indigo-700 rounded-t-md" />
              )}
            </li>
            ...
            >
              <span className="mb-3 cursor-pointer">Contact</span>
              {activeStatus == 4 && (
                <div className="w-full h-1 bg-indigo-700 rounded-t-md" />
              )}
            </li>
