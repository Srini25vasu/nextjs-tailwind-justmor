      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-12">
          {/* <div className="flex items-center">
            <Link
              href="/"
              className="text-cyan-600 text-lg font-bold rounded-md p-1 bg-inherit"
            >
              JusMehr
            </Link>
          </div> */}
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4 text-gray-300  hover:text-white  text-sm font-medium">
              <Link href="/" className="hover:bg-gray-700 rounded-md px-3 py-2">
                Home
              </Link>
              <Link
                href="/profile"
