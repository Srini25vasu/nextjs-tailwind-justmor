...
import beachPic from '../assets/beach-1.jpg';
        ...
        <div className='bg-[url("../assets/beach-1.jpg")] h-screen bg-cover bg-fixed flex items-center'>
            <div className='container mx-auto px-4'>
                <div className='max-w-[450px] text-white flex flex-col gap-[40px]'>
                    ...
                    <div><p>In a professional context it often happens developing fullstack for most of the client applications</p></div>
